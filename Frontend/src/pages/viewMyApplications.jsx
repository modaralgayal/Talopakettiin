...
export const MyApplications = () => {
  ...
  const groupedSections = [
    { title: "Perustiedot", fields: [
      "kaupunki", "maakunta", "budjetti", "talonKoko", "makuuhuoneidenMaara",
      "kodinhoitohuone", "arkieteinen", "terassi", "autokatos", "autotalli"
    ]},
    { title: "Ulkopuoli", fields: [
      "talonMateriaali", "talonMateriaaliMuu", "vesikatto", "vesikattoMuu"
    ]},
    { title: "Sisäpuoli", fields: [
      "lattia", "lattiaDetails", "valiseinat", "valiseinatDetails", "sisakatto", "sisakattoDetails"
    ]},
    { title: "Lämmitys", fields: [
      "lämmitysmuoto", "muuLämmitysmuoto", "takka", "varaavuus", "leivinuuni", "muuTieto"
    ]},
    { title: "Talotekniikka", fields: [
      "minuaKiinnostaa", "muuMinuaKiinnostaa", "haluanTarjous", "muuHaluanTarjous"
    ]},
    { title: "Omat Tiedot", fields: [
      "olen", "vapaamuotoisiaLisatietoja"
    ]}
  ];
              ...
              return (
                <div key={application.entryId} className="mb-4">
                  ...
                  <div className="cursor-pointer bg-gray-200 p-4 rounded-lg" 
                    onClick={() => document.getElementById(`formData-${index}`).classList.toggle("hidden")}>
                    <h2 className="text-lg font-semibold">{kaupunki}</h2>
                    <p className="text-gray-600">Status: {application.status}</p>
                  </div>

                  {/* Collapsible content */}
                  <div id={`formData-${index}`} className="hidden bg-gray-100 p-4 rounded-lg mt-2">
